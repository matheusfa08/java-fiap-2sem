package br.com.agenda.agenda_web.dao;
...
public class ContatoDAO {
    ...
    public void cadastrarContatoEnderecoEntrega(Contato contato) {
        ...
        try {
            ...
            ps.setString(6, contato.getTipo().toString());
    ...
    public Contato consultarContato(int idContato) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                contato.setTipo(TipoEnum.valueOf(rs.getString("tipo"))); //Preciso converter de String para Enum
    ...
    public Contato buscarPorIdAtt(int Id){
        ...
        try{
            ...
            if (rs.next()) {
                ...
                contato.setEmailContato(rs.getString("email_contato"));
                contato.setInstagram(rs.getString("instagram"));
                contato.setTipo(TipoEnum.valueOf(rs.getString("tipo")));
